...
const ExtensionImportHOC = function (WrappedComponent) {
    class ExtensionImportComponent extends React.Component {
        ...
        createFileObjects () {
            ...
            this.removeFileObjects();
            // create fileReader
            this.fileReader1 = new FileReader();
            this.fileReader1.onload = this.onload;
            // create <input> element and add it to DOM
            this.inputElement1 = document.createElement('input');
            this.inputElement1.accept = '.zip';
            this.inputElement1.style = 'display: none;';
            this.inputElement1.type = 'file';
            this.inputElement1.onchange = this.handleChange; // connects to step 3
            console.log(this.inputElement1);
        ...
        onload () {
            ...
            //     this.props.vm.loadProject(this.fileReader1.result)
            //         .then(() => {
            //             if (filename) {
