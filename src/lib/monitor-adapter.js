...
export default function ({id, spriteName, opcode, params, value, vm}) {
    ...
    let {label, category, labelFn} = (vm && ((Object.keys(params).length > 0 && params[0]) ? vm.runtime.getLabelForOpcodeWithArgument(opcode, params[0]) : vm.runtime.getLabelForOpcode(opcode))) || OpcodeLabels.getLabel(opcode);
